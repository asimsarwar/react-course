...
//  👉 Means component renderes for the (First Time) Only
// const App = () => {
//   const [value, setValue] = useState(0);
//   useEffect(() => {
//     console.log("call useEffect");
...
// 5. The cleanup can prevent memory leaks and remove unwanted things. Some use-cases for this are:
...
const App = () => {
  ...
  useEffect(() => {
    console.log('Fetch Data From 3rd Party');
